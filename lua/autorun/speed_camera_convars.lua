...
local speed_camera_trigger_speed = CreateConVar("ttt_speed_camera_trigger_speed", "300", {FCVAR_NOTIFY, FCVAR_ARCHIVE, FCVAR_REPLICATED})
...
TTT_SPEED_CAMERA.CVARS.speed_camera_trigger_speed = speed_camera_trigger_speed:GetInt()
...
if SERVER then
  ...
  cvars.AddChangeCallback("ttt_speed_camera_trigger_speed", function(name, old, new)
    TTT_SPEED_CAMERA.CVARS.speed_camera_trigger_speed = tonumber(new)
  end, nil)
end
